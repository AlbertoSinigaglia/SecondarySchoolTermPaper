...
<html>
    ...
    <body>
        ...
        <header class="w3-container w3-top w3-hide-large w3-blue w3-xlarge w3-padding">
            ...
            <span class="font_google">Info Dipendente</span>
        </header>
                        ...
                        <div class="w3-container w3-card w3-white w3-margin-bottom" style="padding-left:64px !important;">
                            <div class="w3-row">
                                <div class="w3-col l10 m8 s12">
                                    <h2 class="w3-text-grey w3-padding-16"><i class="fa fa-suitcase fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>Dipendente:<b> ${dip.nome} ${dip.cognome}</b></h2>
                                </div>
                            </div>
                            <hr>
                            <div class="w3-container">
                                <p class="w3-text-teal" style="margin:0px !important; padding:1px !important;"><span class="w3-text-black"><b>Email personale:</b></span> <i class="fa fa-calendar fa-fw"></i>${dip.email}</p>
                                <p class="nomargintop" style="margin:0px !important; padding:1px !important;">Telefono personale: ${dip.tel}</p>
                                <c:if test="${dip.tel2!=null&&dip.tel2!=''}">
                                    <p class="nomargintop" style="margin:0px !important; padding:1px !important;">Telefono secondario: ${dip.tel2}</p>
                                </c:if>
                                <p class="nomargintop" style="margin:0px !important; padding:1px !important;">Segnalazioni eseguite: ${dip.nonConf.size()}</p>
                                <p class="nomargintop" style="margin:0px !important; padding:1px !important;">Non conformità gestite: ${dip.nonConfGest.size()}</p>
                                <hr>
                            </div>
                            <div class="w3-row">
                                <div class="w3-col l5">
                                    <h1 class="w3-large w3-text-blue"><b>Segnalazioni eseguite</b></h1>
                                    <hr style="width:100%;border:2px solid #42A5F5" class="w3-round">
                                    <c:if test="${dip.nonConf==null||dip.nonConf.size()==0}">
                                        <div class="w3-container w3-card w3-white w3-margin-bottom" >
                                            <div class="w3-row">
                                                <div class="w3-col l12">
                                                    <h4 class="w3-text-grey w3-padding-16"><i class="fa fa-suitcase fa-fw w3-margin-right w3-small w3-text-teal"></i>Nessuna segnalazione</h4>
                                                </div>
                                            </div>
                                        </div>
                                    </c:if>
                                    <c:forEach items="${dip.nonConf}" var="nc">
                                ...
                                <div class="w3-col l1" style="height:1px;"></div>
                                <div class="w3-col l5">
                                    <h1 class="w3-large w3-text-blue"><b>NC gestite</b></h1>
                                    <hr style="width:100%;border:2px solid #42A5F5" class="w3-round">
                                    <c:if test="${dip.nonConfGest==null||dip.nonConfGest.size()==0}">
                                        <div class="w3-container w3-card w3-white w3-margin-bottom" >
                                            <div class="w3-row">
                                                <div class="w3-col l12">
                                                    <h4 class="w3-text-grey w3-padding-16"><i class="fa fa-suitcase fa-fw w3-margin-right w3-small w3-text-teal"></i>Nessuna non conformità gestita</h4>
                                                </div>
                                            </div>
                                        </div>
                                    </c:if>
                                    <c:forEach items="${dip.nonConfGest}" var="nc">
                                        <div class="w3-container w3-card w3-white w3-margin-bottom" onclick="javascript:location.href = 'infoNC?nr=${nc.nr}'">
                                            <div class="w3-row">
                                                <div class="w3-col l8">
                                                    <h2 class="w3-text-grey w3-padding-16"><i class="fa fa-suitcase fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>NC nr: ${nc.nr}</h2>
