    ...
    <body>
        ...
        <div class="w3-main" style="margin-left:340px;margin-right:40px;  min-height:700px;">
            <div class="w3-container" id="columns" style="margin-top:75px;">
                                ...
                                <div class="w3-container">
                                    ...
                                    <h2><font color="#00BCD4">Complia tutti i seguenti campi:</font></h2>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea  placeholder="Descrivi la problematica riscontrata" name="problematica" id="textarea" style="width:95%"></textarea>
                                        </div>
                ...
                <div class="w3-row">
                    <div class="w3-col l12" id="services" style="margin-top:40px">
                        <h1 class="w3-xxxlarge w3-text-blue"><b>Segnalazioni ricevute</b></h1>
                        <hr style="width:100%;border:5px solid #42A5F5" class="w3-round">
...
<c:forEach items="${segnalazioni}" var="segnalazione">
                        <div class="w3-container w3-card w3-white w3-margin-bottom">
                            <div class="w3-container">
                                <div class="w3-container">
                                    ...
                                    <a href ="gestisci?nr=${segnalazione.nr}" style="margin:10px;" class="bottone">Gestisci</a>
                                    <hr>
                                </div>
                            </div>
                        </div>
        ...
        <script>
            ...
            function controlla() {
                ...
                var vs1 = e.options[e.selectedIndex].value;
                var s = document.getElementById("s1").text;
                if (vs1 !== "auto" && s1.length !== 10)
            ...
            function check(){
                ...
                if(s1!= null && s1!= "auto" &&s2!=null&&s2!="auto"&&textarea!=null&&textarea!="") return true;
