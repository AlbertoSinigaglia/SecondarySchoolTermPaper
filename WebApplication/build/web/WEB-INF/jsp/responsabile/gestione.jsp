<%-- 
    Document   : gestione
    Created on : 21-apr-2018, 9.52.24
...
<html>
    ...
    <body>
            ...
            <div class="w3-container" id="columns" style="margin-top:75px;">
                ...
                <div class="w3-row">
                    <div class="w3-col l12" id="services" style="margin-top:40px; padding-bottom:15px !important;">
                        <h1 class="w3-xxxlarge w3-text-blue"><b>Team operativo</b></h1>
                        ...
                        <div class="w3-container w3-card w3-white w3-margin-bottom" style="padding-bottom:15px !important;">
                            <div class="w3-container">
                                ...
                                <h2><font color="#00BCD4">Seleziona i dipendenti che gestiranno la non conformità:</font></h2>
                                <form method="post" action="convalidaGestione" onsubmit="return check();">
                                    <input type="text" name="nr" value="${nr}" hidden="true">
                                    <c:forEach items="${dipendenti}" var="dip">
                                        <input onclick="set('${dip.email}')" id="${dip.email}" type="checkbox" name="dip" value="${dip.email}"> ${dip.nome} ${dip.cognome}<br>
                                    </c:forEach>       
        ...
        <script>
            ...
            function check(){
                if(i>0) return true;
                document.getElementById("errore").innerHTML="Almeno un dipendente deve essere selezionato";
                return false;
            }
        </script>
    </body>
