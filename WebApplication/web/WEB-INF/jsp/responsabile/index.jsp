...
<body>
    ...
    <div class="w3-main" style="margin-left:340px;margin-right:40px">
        <div class="w3-container" id="columns" style="margin-top:75px">
            ...
            <div class="w3-row">
				...
				<h1 class="w3-xxxlarge w3-text-green"><b>Aperte</b></h1>
			        <hr style="width:100%;border:5px solid green" class="w3-round">
                                ...
                                <c:if test="${dataLA!=null}">
                                <h6 class="w3-text-teal">Ultima inserita il: <i class="fa fa-calendar fa-fw"></i>${dataLA} </h6>
                                </c:if>
                                <c:if test="${dataLA==null}">
                                <h6 class="w3-text-teal">Ultima inserita il: <i class="fa fa-calendar fa-fw"></i>Nessuna NC </h6>
                                </c:if>
                                <hr>
                            </div>
                        </div>
            ...
            <div class="w3-row">
                <h1 class="w3-xxxlarge w3-text-blue"><b>Gestione magazzino</b></h1>
                <hr style="width:100%;border:5px solid #42A5F5" class="w3-round">
                <div class="w3-col l5" id="services" style="margin-top:40px" onclick="location.href='pezzi'">
                    <div class="w3-container w3-card w3-white w3-margin-bottom">
                        <div class="w3-row">
                            <div class="w3-col l12 s12">
				<h1 class="w3-xxlarge w3-text-black"><b>Gestione pezzi</b></h1>
			        <hr style="width:100%;border:5px solid black" class="w3-round">
                                <h3 class="w3-text-grey w3-padding-16">Numero pezzi registrati: ${nPezzi}</h3>
                                <hr>
                            </div>
                        </div>
                    </div>
                ...
                <div class="w3-col l5" id="services" style="margin-top:40px" onclick="location.href='articoli'">
                    <div class="w3-container w3-card w3-white w3-margin-bottom">
                        <div class="w3-row">
                            <div class="w3-col l12 s12">
				<h1 class="w3-xxlarge w3-text-black"><b>Gestione articoli</b></h1>
			        <hr style="width:100%;border:5px solid black" class="w3-round">
                                <h3 class="w3-text-grey w3-padding-16">Numero articoli registrati: ${nArticoli}</h3>
                                <hr>
                            </div>
                        </div>
                    </div>
