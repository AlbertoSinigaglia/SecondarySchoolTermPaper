...
<html>
    <head>
        ...
        <title>Richiesta in sospeso</title>
        <meta charset="UTF-8">
            ...
            <div class="w3-container" id="columns" style="margin-top:75px;">
                ...
                <div class="w3-row">
                    <div class="w3-col l12" id="services" style="margin-top:40px; padding-bottom:15px !important;">
                        <h1 class="w3-xxxlarge w3-text-blue"><b>Richiesta in sospeso.</b></h1>
                        ...
                        <div class="w3-container w3-card w3-white w3-margin-bottom" style="padding-bottom:15px !important;">
                            <div class="w3-container">
                                <h5 class="w3-opacity"><b></b></h5>
                                <h4>Per avere l'accesso al portale, dovrai aspettare che il responsabile ti autorizzi all'accesso, fino a quel momento non potrà accedere <br> Grazie.</h4>
                            </div>
                            <hr>
                            <div class="w3-row">
