...
public class NonConformitaServiceImpl implements NonConformitaService {
    ...
    public NonConformita updateNonConformita(NonConformita nc) {
        ...
        if(entity!=null){
            ...
            entity.setDipendentiGest(nc.getDipendentiGest());
            entity.setCliente(nc.getCliente());
            entity.setPezzo(nc.getPezzo());
            entity.setArticolo(nc.getArticolo());
            entity.setDipendenteRisc(nc.getDipendenteRisc());
        }
        return entity;
    }
